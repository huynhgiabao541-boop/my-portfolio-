  ...
  return (
    <section id="skills" className="space-y-12 relative z-10">
      <div className="flex items-center gap-4">
        ...
        <h2 className="text-3xl font-bold text-slate-900 dark:text-white">Kỹ năng & Chuyên môn</h2>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <LiquidPill className="w-full flex items-center p-4 text-left">
          ...
          <div>
            <h4 className="font-bold text-slate-900 dark:text-white mb-1">Công cụ & Kỹ năng mềm</h4>
            <p className="text-sm text-slate-600 dark:text-slate-400">{skills.tools.join(', ')}. {skills.softSkills.join(', ')}.</p>
          </div>
        </LiquidPill>
